...
public class ContactController {
    ...
    public String searchHandler(
        ...
        if (field.equalsIgnoreCase("name")) {
            contacts = contactService.searchByUserAndName(user, value);
        } else if (field.equalsIgnoreCase("email")) {
            contacts = contactService.searchByUserAndEmail(user, value);
        } else if (field.equalsIgnoreCase("phone")) {
            contacts = contactService.searchByUserAndPhoneNumber(user, value);
        }
